...
public class WordListOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DATA_BASE_NAME = "datanya";
    private static final String WORD_LIST_TABLE = "wordlist";

    public static final String KEY_ID = "_id";
    public static final String KEY_WORD = "word";

    private static final String[] COLOM = {KEY_ID, KEY_WORD};
    ...
    public int update(int id, String word) {
        ...
        try {
            ...
            ContentValues values = new ContentValues();
            values.put(KEY_WORD, word);
            mNumberOfRowsUpdate = mWritableDB.update(WORD_LIST_TABLE,
                    values,
                    KEY_ID + " = ? ",
